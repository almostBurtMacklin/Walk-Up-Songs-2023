...
def start_dash_app_frozen():
    ...
    print('trying to start', path_dir +"\index.py" )
    subprocess.Popen(path_dir +"\index.py", shell=True)

# Start the driver
# def start_driver():
#     driver = webdriver.Chrome()
#     time.sleep(5) # give dash app time to start running
#     driver.get("http://127.0.0.1:8050/") # go to the local server
...
def main():
    ...
    # start selenium controled chrome browser and go to port
