                ...
                dmc.Paper(
                    ...
                    children = [
                        dmc.SimpleGrid(
                            cols = 5,
                            children = [
                                dmc.Button('Star Spangled Banner'),
                                dmc.Button('Can You Feel It'),
                                dmc.Button('Home Run Song'),
                                dmc.Button('Angels in the Outfield'),
                                dmc.Button('Jeopardy Theme'),
                                dmc.Button('Little Less Conversation'),
                                dmc.Button('Player Intro (FOX)'),
                                dmc.Button('On To The Next'),
                                dmc.Button('Pre Game Rumble'),
